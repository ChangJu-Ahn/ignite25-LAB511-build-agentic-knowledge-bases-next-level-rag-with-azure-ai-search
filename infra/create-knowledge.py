...
LOG_FILE = r"C:\Users\LabUser\Desktop\ignite25-LAB511-private-dev\infra\index-creation.log"
...
async def restore_index(endpoint: str, index_name: str, index_file: str, records_file: str, azure_openai_endpoint: str, credential: AzureKeyCredential):
    default_path = r"C:\Users\LabUser\Desktop\ignite25-LAB511-private-dev\data\index-data"
